...
router.post("/", async (req, res) => {
  // create a new tag
  try {
    // uses .create to create a tag and the value of that tag will be the id from the post request that is made by the user
...
router.put("/:id", async (req, res) => {
  ...
  try {
    // updating the tag_name of an instance of a category in the db with the tag_name from the put request made by the user
